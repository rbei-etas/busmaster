...
void CSignalDetailsDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDV_MinMaxByte(pDX, m_byByteIndex, 1, 8);
    DDX_Text(pDX, IDC_EDIT_SGLEN, m_unSgLen);
    DDV_MinMaxUInt(pDX, m_unSgLen, 1, m_nMsgLength*8);
...
BOOL CSignalDetailsDlg::OnInitDialog()
{
    ...
    m_omSpinLen.SetRange( 1, (short)unMaxSignalLength );
        ...
        else if(bReturnFlag == TRUE)
        {
            ...
            if ( bReturnFlag == TRUE)
            {
                ...
                if ( pSg != NULL )
                {
                    ...
                    pSg->m_byStartByte              = m_byByteIndex;
...
BOOL CSignalDetailsDlg::bIsMinimumValueValid()
{
    ...
    {
        __int64 un64 = nConvertStringToInt(m_omStrMinVal);
