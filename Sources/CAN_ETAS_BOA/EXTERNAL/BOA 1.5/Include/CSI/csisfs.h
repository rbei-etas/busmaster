...
typedef enum CSI_NodeType
{
   ...
   /** The protocol represents the OSI-DataLink Layer */
   CSI_NODE_PROTOCOL_OSI_DATALINK = 0x4200,
   CSI_NODE_PROTOCOL_OCIG = 0x4280,
   /** The protocol represents the OSI-Network Layer */
   CSI_NODE_PROTOCOL_OSI_NETWORK = 0x4400,
   /** The protocol represents the OSI-Trasnsport Layer */
   CSI_NODE_PROTOCOL_OSI_TRANSPORT = 0x4600,
    /** The protocol represents the OSI-Session Layer */
   CSI_NODE_PROTOCOL_OSI_SESSION   = 0x4800,
    /** The protocol represents the OSI-Application Layer */
   CSI_NODE_PROTOCOL_OSI_APPLICATION = 0x4A00,
...
typedef struct CSI_SubItem
{
   ...
   */
   ...
   /** version of this structure. Use V1.1.0.0 for items that include serverAffinity
       and requiredAffinity information. */
   BOA_Version version;
...
/**
 ...
 @param [in] size       Size of  the @a uriName array. The function will not deliver more than @a size elements.
                        When more than @a size elements are found the function will return with OCI_ERR_BUFFER_OVERFLOW
