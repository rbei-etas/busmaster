...
*
* Note that 0 is a valid value for an instance of BOA_Handle. BOA_NO_VALUE is used to represent an invalid value.
*/
...
* invalid handle.
*/
#define BOA_NO_HANDLE (BOA_Handle)BOA_NO_VALUE
