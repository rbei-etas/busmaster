...
BEGIN_MESSAGE_MAP(CCANControllerConfigDlg, CDialog)
  ON_BN_CLICKED(IDC_BUTTON_CANCFG_OK, &CCANControllerConfigDlg::OnBnClickedButtonCancfgOk)
  ON_CBN_SELENDOK(IDC_COMBO_CIA_BAUD_SELECTION, &CCANControllerConfigDlg::OnCbnSelendokComboCiaBaudSelection)
  ON_BN_CLICKED(IDC_BUTTON_CANCEL, &CCANControllerConfigDlg::OnBnClickedButtonCancel)
  ON_EN_CHANGE(IDC_EDIT_BITREG0, &CCANControllerConfigDlg::OnEnChangeEditBitreg0)
  ON_EN_CHANGE(IDC_EDIT_BITREG1, &CCANControllerConfigDlg::OnEnChangeEditBitreg1)
END_MESSAGE_MAP()
