 ...
 */
#if !defined CAN_ETAS_ES581_EXTERN_H__INCLUDED_
#define CAN_ETAS_ES581_EXTERN_H__INCLUDED_
...
USAGEMODE HRESULT CAN_ES581_Usb_GetTimeModeMapping(SYSTEMTIME& CurrSysTime, UINT64& TimeStamp, LARGE_INTEGER* QueryTickCount = NULL);
USAGEMODE HRESULT CAN_ES581_Usb_ListHwInterfaces(INTERFACE_HW_LIST& sSelHwInterface, INT& nCount);
USAGEMODE HRESULT CAN_ES581_Usb_SelectHwInterface(const INTERFACE_HW_LIST& sSelHwInterface, INT nCount);
...
USAGEMODE HRESULT CAN_ES581_Usb_SetConfigData(PCHAR pInitData, int Length);
...
USAGEMODE HRESULT CAN_ES581_Usb_SendMsg(DWORD dwClientID, const STCAN_MSG& sCanTxMsg);
USAGEMODE HRESULT CAN_ES581_Usb_GetBoardInfo(s_BOARDINFO& BoardInfo);
USAGEMODE HRESULT CAN_ES581_Usb_GetBusConfigInfo(BYTE* BusInfo);
...
USAGEMODE HRESULT CAN_ES581_Usb_FilterFrames(FILTER_TYPE FilterType, TYPE_CHANNEL Channel, UINT* punMsgIds, UINT nLength);
...
#endif // CAN_ETAS_ES581_EXTERN_H__INCLUDED_