                               ...
                               UINT64 u64SignVal)
{
    ...
    if ( pouCurrSignal->m_eFormat == eEndianess:: eIntel)// If Intel format
    {
...
sSIGNALS* tagSMSGENTRY::psCopySignalVal(sSIGNALS* psSignal)
{
    ...
    if (nullptr != Result && nullptr != psSignal)
    {
