...
class J1939NsCodeGenHelper : public INsCodeGenHelper, public IPduCodeGenHelper, public IFrameCodeGenHelper
{
    ICluster* mCluster;
public:
    J1939NsCodeGenHelper();
    virtual ~J1939NsCodeGenHelper();
