...
CSelectFunctions::CSelectFunctions(ETYPE_BUS eBus, CGlobalObj* pGlobalObj, CWnd* pParent /*=nullptr*/)
...
BOOL CSelectFunctions::OnInitDialog()
{
    ...
    int nCount = (COMMANINT)m_pGlobalObj->m_ArrAPIsList.GetSize();
    for (int i = 0; i < nCount; i++)
    {
        m_omFnListBox.AddString( m_pGlobalObj->m_ArrAPIsList.GetAt(i) );
    }
