...
/*  Functionality    :  This function will create a vertical splitter
                        and associates a single view for it. Calls Create Toolbar.
/*  Member of        :  CSimSysWnd                                            */
/*  Friend of        :      -                                                 */
/*                                                                            */
/*  Author(s)        :  Harika.M                                              */
...
BOOL CSimSysWnd::OnCreateClient( LPCREATESTRUCT /*lpcs*/, CCreateContext* pContext )
{
    ...
    m_pSimSysTreeView->Create( this, pContext );
    m_pSimSysTreeView->OnInitialUpdate();
...
void CSimSysWnd::OnShowWindow(BOOL bShow, UINT nStatus)
{
    ...
    if (bShow)
    {
        m_pSimSysTreeView->bPopulateTree();
...
void CSimSysWnd::vMoveSimSysTreeView(CRect rect)
{
    m_pSimSysTreeView->MoveWindow(rect);
}

void CSimSysWnd::OnSize( UINT nType, int cx, int cy )
{
    ...
    rect.bottom = clientRect.bottom + toolbarRect.Height();
    vMoveSimSysTreeView(rect);
}
