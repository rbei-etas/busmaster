...
void ScheduleTableDlg::onDelayEditChange(const QString& str)
{
    ...
    {
        QVariant qVar;
        CLINSheduleTableItem ouSchedTableItem = ui.tableFrames->item( nRow, 0)->data(Qt::UserRole).value<CLINSheduleTableItem>();
...
void ScheduleTableDlg::OnButtonClickOk()
{
    if ( 0 == nValidateValues() )
    {
        ...
        {
            CLINSheduleTableItem ouTableItem = ui.tableFrames->item(i, 0)->data(Qt::UserRole).value<CLINSheduleTableItem>();
...
void ScheduleTableDlg::vPopulateSelFrameDetails(int nIndex)
{
    ...
    if(nSelectedRow >= 0)
    {
        ...
        CLINSheduleTableItem omSchedItem = ui.tableFrames->item(nSelectedRow, 0)->data(Qt::UserRole).value<CLINSheduleTableItem>();
...
void ScheduleTableDlg::vPopulatePropertyView(CLINSheduleTableItem& ouSchedTableItem)
{
...
void ScheduleTableDlg::onCondNADEditChange(const QString& strText)
{
    ...
    {
        QVariant qVar;
        CLINSheduleTableItem ouSchedTableItem = ui.tableFrames->item( ui.tableFrames->currentRow(), 0)->data(Qt::UserRole).value<CLINSheduleTableItem>();
...
ERRORCODE ScheduleTableDlg::vPopulateAssignFrameId(CLINSheduleTableItem& ouSchedTableItem)
{
    std::map<UID_ELEMENT, IElement*> mapEcus;
    std::map<UID_ELEMENT, IElement*> mapFrames;
    eEcuType ouECUType;
