...
#define OCI_ERR_QUEUE_IS_FULL               BOA_ERR_QUEUE_IS_FULL
    ...
    /** @copydoc  BOA_ERR_OBJECT_IN_USE */
#define OCI_ERR_OBJECT_IN_USE               BOA_ERR_OBJECT_IN_USE

    /** @copydoc  BOA_ERR_LATER_VERSION_IN_USE */
#define OCI_ERR_LATER_VERSION_IN_USE        BOA_ERR_LATER_VERSION_IN_USE
