...
struct msgBufferSettings
{
    bool mISValidSettings;
    unsigned int mAppendSize;
    unsigned int mOverWriteSize;
    unsigned int mDisplayUpdateRate;
};
class CMsgBufferConfigPage : public CPropertyPage
{
    ...
    // Construction
    msgBufferSettings* mMsgBufferSettings;
public:
    CMsgBufferConfigPage(msgBufferSettings*);
