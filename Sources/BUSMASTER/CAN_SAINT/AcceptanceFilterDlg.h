...
protected:
    ...
    CString m_omStrLocalAccCodeByte1[defCAN_MSG_IDS];
	CString m_omStrLocalAccCodeByte2[defCAN_MSG_IDS];
	CString m_omStrLocalAccCodeByte3[defCAN_MSG_IDS];
	CString m_omStrLocalAccCodeByte4[defCAN_MSG_IDS];
	CString m_omStrLocalAccMaskByte1[defCAN_MSG_IDS];
	CString m_omStrLocalAccMaskByte2[defCAN_MSG_IDS];
	CString m_omStrLocalAccMaskByte3[defCAN_MSG_IDS];
	CString m_omStrLocalAccMaskByte4[defCAN_MSG_IDS];
