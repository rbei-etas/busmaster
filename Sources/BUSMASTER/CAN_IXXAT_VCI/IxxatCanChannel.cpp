 ...
 *
 */
HRESULT CIxxatCanChannel::GetStatus(STATUSMSG* pStatusData)
{
    HRESULT hResult = HW_INTERFACE_NO_SEL;
    if (m_hCANChannel)
    {
 ...
 *
 */
void CIxxatCanChannel::ConvertIxxatStatusToBusmasterStatus(CANCHANSTATUS* pIxxatChannelStatus, STATUSMSG* pStatusData)
{
    /*
    ...
    */
    ...
    ZeroMemory(pStatusData, sizeof(STATUSMSG));
