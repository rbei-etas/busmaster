...
extern "C" {
    ...
    /**
      @brief    The LIC API provides licence information obtained from a connected hardware controller. This API is DEPRECATED, please use the DEV API.
...
#define UUID_LIC {0xA4,0x79,0xF2,0x0A,0x41,0x60,0x45,0xe7,0xBF,0xA9,0x08,0x09,0x0A,0xF2,0x59,0xDA}
    ...
    BOA_DECLSPEC_DEPRECATED_FUNC( LIC_DECLSPEC LIC_ErrorCode
    ...
    */
#ifndef LIC_DYNAMICDLL
    BOA_DECLSPEC_DEPRECATED_FUNC( LIC_DECLSPEC LIC_ErrorCode
                                  LIC_CALL LIC_CreateSessionVersion(
                                      const char*         uriLocation,
                                      BOA_Version*        apiVersion,
                                      LIC_SessionHandle*  phSession
                                  ));
#endif
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_CreateSessionBind instead.
    ...
    */
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_DestroySession instead.
...
#define LIC_MAX_LICENCE_VALUE 128
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_GetLicenceValue instead.
...
#define LIC_MAX_DEVICE_ID 128
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_GetDeviceId instead.
...
#define LIC_MAX_BLOBNAME_LEN 64
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_SetLicenceBlob instead.
    ...
    */
    ...
    /**
      ...
      @deprecated This function is deprecated, please use @ref DEV_GetLicenceBlob instead.
