...
extern "C" {
    ...
    */
    ...
    /**
     * The different types of baudrate which a LIN slave allows an OCI_LIN client to specify in the field OCI_LINConfiguration::baudrate.
     */
    typedef enum
    {
        /** The LIN slave only supports a manually-specified baudrate. The OCI_LIN client must manually specify a baudrate in the
        * field OCI_LINConfiguration::baudrate. */
        OCI_LIN_MANUAL_BAUDRATE         = 1,

        /** The LIN slave only supports automatic baudrate detection. The OCI_LIN client cannot specify a non-zero baudrate in the field
        * OCI_LINConfiguration::baudrate. The LIN node will auto-detect the correct baudrate. */
        OCI_LIN_AUTO_BAUDRATE           = 2,

        /** The LIN slave supports both automatic baudrate detection and manual baudrate specification. The OCI_LIN client can select
         * an automatic or manual baudrate via the field OCI_LINConfiguration::baudrate. */
        OCI_LIN_AUTO_OR_MANUAL_BAUDRATE = 4

    } OCI_LIN_BAUDRATE_TYPE;
    ...
    */
    typedef struct OCI_LINControllerCapabilities
    {
        ...
        */
        ...
        /**
         * The types of baudrate supported by the controller if it is configured as a LIN slave. This field was introduced in
         * v1.1 of the OCI(G)_LIN API.
         * OCI clients cannot rely on the value of this field unless, when the caller's OCI_LIN session was created, the OCI(G)_LIN
         * API was bound to least v1.1.
         * Implementations of OCI(G)_LIN should not populate this field unless, when the current session was created, the supplied
         * protocol stack indicated at least v1.1 of OCI(G)_LIN.
         * Implementations of RPC_OCI_LIN should not populate this field unless, when the current session was created, the supplied
         * protocol stack indicated at least v1.2 of RPC_OCI_LIN.
         */
        OCI_LIN_BAUDRATE_TYPE slaveBaudrateType;
...
#define OCI_LIN_WAKEUP_INTERNAL   0x01
    ...
    */
    typedef
#ifdef MIDL_RUNNING
    [switch_type(OCI_LINEvent)]
#endif
    union OCI_LINEventUnion
    {
        /**
    ...
    */
    typedef
#ifdef MIDL_RUNNING
    [switch_type(OCI_LINMessageDataType)]
#endif
    union OCI_LINMessageData
    {
        /**
    ...
    [case(OCI_LIN_EVENT)]
        ...
        */
#ifdef MIDL_RUNNING
    [case(OCI_LIN_INTERNAL_ERROR_EVENT)]
#endif
    ...
    [case(OCI_LIN_QUEUE_EVENT)]
        ...
        */
#ifdef MIDL_RUNNING
    [case(OCI_LIN_SLEEP_MODE_CONTROL)]
#endif
    ...
    */
    ...
    /**
      ...
      @return
       ...
       <tr> <td> @ref OCI_ERR_NOT_IMPLEMENTED </td>
            <td> The controller does not support LIN transmission. The structure OCI_LINControllerCapabilities obtained
                 via OCI_GetLINControllerCapabilities() can be used to discover whether transmission is supported. </td>
       </tr>
      </TABLE>
    ...
    */
    ...
    /**
     Signature of a callback function for LIN event and message handling. A callback function matching this signature is
     able to receive only one LIN event or message in a single invocation. The alternative, @ref OCI_LINRxCallbackFunction,
     is able to receive multiple LIN events and/or messages per invocation.

     @param[in] userData When the callback is executed, this argument will contain the value of the field
                         @ref OCI_LINRxCallbackSingleMsg::userData which was supplied to @ref OCI_CreateLINRxQueue()
                         when the RX queue was created. This value is opaque to the BOA framework. It is only meaningful
                         to the BOA client.
    ...
    */
    typedef void (OCI_CALLBACK* OCI_LINRxCallbackFunctionSingleMsg)( void* userData, OCI_LINMessage* msg );

    /**
        \brief Callback for LIN event and message handling
    ...
    */
    typedef struct OCI_LINRxCallbackSingleMsg
    {
        /** Callback function pointer */
        OCI_LINRxCallbackFunctionSingleMsg function;
    ...
    */
    typedef struct OCI_LINRxQueueConfiguration
    {
        ...
        *
        * Note that if @ref OCI_DestroyLINRxQueue() or @ref OCI_DestroyLINController() is called while reception
        * is in progress, it is possible for a final call to @ref onFrame to be made a short time @em after
        * @ref OCI_DestroyLINRxQueue() or @ref OCI_DestroyLINController() has returned successfully.
        *
        * @sa @ref PAGE_OCI_RECEIVE_MESSAGES "Receive Messages"
        */
#ifndef MIDL_RUNNING
        OCI_LINRxCallbackSingleMsg onFrame;
#endif
        ...
        *   - If @ref OCI_DestroyLINRxQueue() or @ref OCI_DestroyLINController() is called while reception
        ...
        */
#ifndef MIDL_RUNNING
        OCI_LINRxCallbackSingleMsg onEvent;
#endif
