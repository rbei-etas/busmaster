...
int CCheckColumnTreeCtrl::nUpdateScheduleView()
{
    ...
    ClusterConfig* ouClusterConfig = CLINScheduleDataStore::pGetLINSchedDataStore().pGetClusterConfig();
    ...
    for(INT nIndex = 0; nIndex < ouClusterConfig->m_nChannelsConfigured; nIndex++)
    {
