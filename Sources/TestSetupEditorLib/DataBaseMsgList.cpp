    ...
    if ( bValidateDatabaseFile(strFileName) )
    {
        ...
        TRY
        {
            ...
            if(bIsFileOpen != FALSE )
            {
                ...
                if (nIndex != -1)
                {
                    ...
                    {
                        strncpy(s_acTraceStr, DATABASE_MISMATCH, sizeof(s_acTraceStr));
                                        ...
                                        BOOL bLineRead = FALSE;
                                            ...
                                            while (unNumberofSignalsRead < m_psMessages[unMsgCount].m_unNumberOfSignals)
                                            {
                                                ...
                                                if ( nIndex != -1)
                                                {
                                                    ...
                                                    if (sTempSg == NULL)
                                                    {
                                                        strncpy(s_acTraceStr, MSG_MEMORY_CONSTRAINT, sizeof(s_acTraceStr));
                                                            //TODO::    vWriteTextToTrace();
                                                        bReturnValue = FALSE;
                                                        break;
                                                    }
        ...
        CATCH_ALL (pomE)
        {
            if(pomE != NULL )
            {
                ...
                strncpy(s_acTraceStr, lpszError, sizeof(s_acTraceStr));
                //TODO::    vWriteTextToTrace();
                pomE->Delete();
            }
