 ...
 */
#if !defined CAN_BOA_EXTERN_H__INCLUDED_
#define CAN_BOA_EXTERN_H__INCLUDED_
...
USAGEMODE HRESULT CAN_BOA_GetTimeModeMapping(SYSTEMTIME& CurrSysTime, UINT64& TimeStamp, LARGE_INTEGER* QueryTickCount = NULL);
USAGEMODE HRESULT CAN_BOA_ListHwInterfaces(INTERFACE_HW_LIST& sSelHwInterface, INT& nCount);
USAGEMODE HRESULT CAN_BOA_SelectHwInterface(const INTERFACE_HW_LIST& sSelHwInterface, INT nCount);
...
USAGEMODE HRESULT CAN_BOA_GetCurrStatus(s_STATUSMSG& StatusData);
...
#endif // CAN_BOA_EXTERN_H__INCLUDED_