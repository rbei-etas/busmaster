...
#pragma once
#include "TxWindowEthernet_stdafx.h"             // For Standard Includes
#include "Tx_MDIChildBase.h"       // For MDI Base class definition
#include "TxEthernetDataStore.h"    // For Tx Window Configuration
...
void CMDIChildBase::vSaveWinStatus()
{
                ...
                sizeof(WINDOWPLACEMENT)) != 0 )
    {
        ...
        {
            CTxEthernetDataStore::ouGetTxEthernetDataStoreObj().bSetTxData(TX_WINDOW_PLACEMENT, &m_sWindowPlacement);
        }
    }
}
