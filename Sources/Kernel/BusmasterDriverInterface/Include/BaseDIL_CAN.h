...
public:
     ...
     */
    virtual HRESULT DILC_GetTimeModeMapping(SYSTEMTIME& CurrSysTime, UINT64& TimeStamp, LARGE_INTEGER& QueryTickCount) = 0;
    ...
    * Call to get descriptive string of the last error occurred
    ...
    virtual HRESULT DILC_SetHardwareChannel( PSCONTROLLER_DETAILS m_asControllerDetails, DWORD dwDriverId, bool bHardwareListed = true, unsigned int unChannelCount = defCHANNEL_CAN_MAX ) = 0;
};
