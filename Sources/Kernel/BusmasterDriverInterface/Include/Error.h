...
const HRESULT HW_INTERFACE_ALREADY_SELECTED = MASK_INFO| DILLIB | 0x0E; // Hardware interface already selected
const HRESULT HW_INTERFACE_ALREADY_CLOSED = MASK_INFO| DILLIB | 0x0F; // Hardware interfaces already closed
...
const HRESULT INFO_INITDAT_CONFIRM_CONFIG   = MASK_INFO| DILLIB | 0x14; // Controller initialisation data confirmed and controller successfully configured
const HRESULT ERR_INITDAT_CONFIRM_CONFIG = MASK_ERR | DILLIB | 0x15; // Controller initialisation data confirmed but failure in controller configuration
...
const HRESULT ERR_EXCEED_PERMITTED_VALUE = MASK_ERR | COMMON | 0x05; // Value in question exceeds limit
