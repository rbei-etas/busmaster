...
#include "EXTERNAL_INCLUDE/NSI/Canpcex.h"
...
static char* GetCodeString(short cr)
{
	...
	{
	case _OK : return ": OK.";
	case _MEM_ERR : return ": Memory error.";
	case _SEQ_ERR : return ": Sequence error.";
	case _PARAM_ERR : return ": Parameter error.";
	case _CHIP_ERR : return ": Chip error.";
	case _BOARD_ERR : return ": Board error.";
	...
	case _INVALID_OP : return ": Channel invalid or already in use.";
	case _DRV_PARAM_ERR : return ": Error acessing driver.";
	case _OPENING_DRV_ERR : return " : Error opening driver.";
