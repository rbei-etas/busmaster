...
/**
 * \file      FlexListCtrl.h
 * \brief     This file contain the definition of CLinFlexListCtrl class
 * \author    Raja N
 * \copyright Copyright (c) 2011, Robert Bosch Engineering and Business Solutions. All rights reserved.
 *
 * This file contain the definition of CLinFlexListCtrl class
 */
...
#include "FFListCtrl.h"                 // For data struct definition
//#include "Utility/ComboItem.h"
//#include "Utility/NumEdit.h"
//#include "Utility/AlphaChar.h"
/////////////////////////////////////////////////////////////////////////////
// CLinFlexListCtrl window
class CLinFlexListCtrl : public CFFListCtrl
{
    // Construction
public:
    CLinFlexListCtrl();
...
public:
   ...
   /* CComboItem* pomComboList( int nItem, int nSubItem,
    ...
    // Destructor
    virtual ~CLinFlexListCtrl();

    // Generated message map functions
protected:
    //{{AFX_MSG(CLinFlexListCtrl)
