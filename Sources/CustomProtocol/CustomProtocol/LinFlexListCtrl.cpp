 ...
 * \brief     Implementation file for CLinFlexListCtrl
 * \author    Raja N
 * \copyright Copyright (c) 2011, Robert Bosch Engineering and Business Solutions. All rights reserved.
 *
 * Implementation file for CLinFlexListCtrl
 */
...
#include "LinFlexListCtrl.h"				// Interface file for Flex List Control
...
// CLinFlexListCtrl
/******************************************************************************
 Function Name  :   CLinFlexListCtrl
...
******************************************************************************/
CLinFlexListCtrl::CLinFlexListCtrl() : m_bSingleClickActivate(FALSE)
{
...
/******************************************************************************
 ...
 Modifications  :
******************************************************************************/
CLinFlexListCtrl::~CLinFlexListCtrl()
{
}


BEGIN_MESSAGE_MAP(CLinFlexListCtrl, CListCtrl)
    //{{AFX_MSG_MAP(CLinFlexListCtrl)
...
/////////////////////////////////////////////////////////////////////////////
// CLinFlexListCtrl message handlers
...
/******************************************************************************
 ...
 Modifications  :
******************************************************************************/
void CLinFlexListCtrl::OnEndlabeledit(NMHDR* pNMHDR, LRESULT* pResult)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
    // Set the focus to list control. This will hide any controls that
    // are all visible at this time
...
*******************************************************************************/
void CLinFlexListCtrl::OnDoubleClick(NMHDR* pNMHDR, LRESULT* pResult)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::vSetColumnInfo(int nRow, int nColunm, SLISTINFO sInfo)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
SLISTINFO CLinFlexListCtrl::sGetColumnInfo(int nRow, int nColunm)
{
...
*******************************************************************************/
long CLinFlexListCtrl::lGetMapID(int nRow, int nCol)
{
...
*******************************************************************************/
void CLinFlexListCtrl::vShowControl(int nItem, int nSubItem)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
//CComboItem* CLinFlexListCtrl::pomComboItem(int nItem,
//        int nSubItem,
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
//CComboItem* CLinFlexListCtrl::pomComboList( int nItem,
//        int nSubItem,
//        const CStringArray& omList)
//{
//    // Get the item text from the list control
...
CEdit* CLinFlexListCtrl::pomEditItem(int nItem, int nSubItem)
{
    ...
    {
        CString omStrErr;
        omStrErr.Format( _T(defFLC_CREATE_FAILED), defEDIT_ITEM );
        AfxMessageBox( omStrErr );
    }
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
//CNumEdit* CLinFlexListCtrl::pomNumItem( int nItem, int nSubItem,
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::vSetNumericInfo( int nRow, int nColunm,
                                        const SNUMERICINFO& sInfo)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::vSetUserProgInfo( int nRow, int nColunm,
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
BOOL CLinFlexListCtrl::sGetModificationStructure(LV_DISPINFO& rs_DispInfo)
{
    BOOL bSuccess = TRUE;
...
/*******************************************************************************
 ...
 Modifications  : Raja N on 30.07.2004, Renamed the function name as per code
                  review comments.
*******************************************************************************/
void CLinFlexListCtrl::vGoToEditMode(int nItem, int nSubItem)
{
...
/*******************************************************************************
 ...
 Modifications  :
*******************************************************************************/
void CLinFlexListCtrl::vSetMapColumnCount(int nColumn)
{
