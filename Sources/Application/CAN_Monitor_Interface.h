...
public:
    ...
    typedef struct IApplicationVtbl
    {
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* LoadAllDll )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* UnLoadAllDll )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* StartTxMsgBlock )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* StopTxMsgBlock )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ResetHW )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ResetSW )(
            IApplication* This);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* DisplayWindow )(
            IApplication* This,
            eWindow eWhichWindow);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetMsgInfo )(
            IApplication* This,
            BSTR MsgName,
            sMESSAGESTRUCT* sMsgStruct);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* SendKeyValue )(
            IApplication* This,
            UCHAR keyval);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ImportDatabase )(
            IApplication* This,
            BSTR DBFilePath);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* EnableDisableHandlers )(
            IApplication* This,
            BOOL bEnable,
            eHandlerType eType);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetErrorCounter )(
            IApplication* This,
            UCHAR* Tx,
            UCHAR* Rx,
            INT nChannel);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* SendCANMSg )(
            IApplication* This,
            CAN_MSGS* sMsg);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetNetworkStatistics )(
            IApplication* This,
            int nChannel,
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* WriteToLogFile )(
            IApplication* This,
            USHORT BlockIndex,
            BSTR pcStr);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* AddLoggingBlock )(
            IApplication* This,
            SLOGGINGBLOCK_USR* psLoggingBlock);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* SaveConfigurationAs )(
            IApplication* This,
            BSTR ConfigPath);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* AddTxBlock )(
            IApplication* This,
            STXBLOCK_USR* psTxBlock);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetTxBlockCount )(
            IApplication* This,
            USHORT* Result);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetTxBlock )(
            IApplication* This,
            USHORT BlockIndex,
            STXBLOCK_USR* psTxBlock);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* DeleteTxBlock )(
            IApplication* This,
            USHORT BlockIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ClearTxBlockList )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* AddMsgToTxBlock )(
            IApplication* This,
            USHORT BlockIndex,
            CAN_MSGS* psMsg);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetMsgCount )(
            IApplication* This,
            USHORT BlockIndex,
            USHORT* Result);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetMsgFromTxBlock )(
            IApplication* This,
            USHORT BlockIndex,
            USHORT MsgIndex,
            CAN_MSGS* psMsg);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* DeleteMsgFromTxBlock )(
            IApplication* This,
            USHORT BlockIndex,
            USHORT FrameIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ClearMsgList )(
            IApplication* This,
            /* [in] */ USHORT BlockIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* AddFilterScheme )(
            IApplication* This,
            /* [in] */ BSTR pcFilterName,
            /* [in] */ VARIANT_BOOL FilterType);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetFilterScheme )(
            IApplication* This,
            /* [in] */ USHORT FilterSchINdex,
            /* [in] */ BSTR pcFilterName,
            /* [in] */ VARIANT_BOOL* FilterType);
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetFilterSchCount )(
            IApplication* This,
            /* [out] */ USHORT* pTotal);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* UpdateFilterSch )(
            IApplication* This,
            /* [in] */ USHORT FilterSchIndex,
            /* [in] */ SFILTER_USR* psFilter);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetFilterCountInSch )(
            IApplication* This,
            /* [in] */ USHORT FilterSchIndex,
            /* [out] */ USHORT* pTotal);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetFilterInFilterSch )(
            IApplication* This,
            /* [in] */ USHORT FilterSchIndex,
            /* [in] */ USHORT FilterIndex,
        ...
        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* DeleteFilterInSch )(
            IApplication* This,
            /* [in] */ USHORT FilterSchIndex,
            /* [in] */ USHORT FilterIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* EnableFilterSch )(
            IApplication* This,
            /* [in] */ EFILTERMODULE eModule,
            /* [in] */ BOOL Enable);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* AddSimulatedSystem )(
            IApplication* This,
            /* [in] */ BSTR pcSimPath);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetSimulatedSystemCount )(
            IApplication* This,
            /* [out] */ USHORT* pSimTotal);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetSimulatedSystemName )(
            IApplication* This,
            /* [in] */ USHORT SimSysIndex,
            /* [out] */ BSTR* pcSimPath);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* DeleteSimulatedSystem )(
            IApplication* This,
            /* [in] */ USHORT SimSysIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* RemoveLoggingBlock )(
            IApplication* This,
            /* [in] */ USHORT BlockIndex);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetLoggingBlockCount )(
            IApplication* This,
            /* [out] */ USHORT* BlockCount);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* ClearLoggingBlockList )(
            IApplication* This);

        /* [helpstring][id] */
        HRESULT ( STDMETHODCALLTYPE* GetLoggingBlock )(
            IApplication* This,
            /* [in] */ USHORT BlockIndex,
