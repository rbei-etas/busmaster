 ...
 * \brief     Contains the description of the class CFlexRayDatabaseDissociateDlg
 * \author    Ratnadip Choudhury
 * \copyright Copyright (c) 2011, Robert Bosch Engineering and Business Solutions. All rights reserved.
 *
 * Contains the description of the class CFlexRayDatabaseDissociateDlg
 */
#include "stdafx.h"
#include "BUSMASTER.h"
...
IMPLEMENT_DYNAMIC(CFlexRayDatabaseDissociateDlg, CDialog)
CFlexRayDatabaseDissociateDlg::CFlexRayDatabaseDissociateDlg(FLEXRAY_CONFIG_FILES& sFibexParams, CWnd* pParent /*=nullptr*/)
    : CDialog(CFlexRayDatabaseDissociateDlg::IDD, pParent),
      m_sFibexParams(sFibexParams)
{
}

CFlexRayDatabaseDissociateDlg::~CFlexRayDatabaseDissociateDlg()
{
}

void CFlexRayDatabaseDissociateDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CFlexRayDatabaseDissociateDlg, CDialog)
...
/******************************************************************************
  ...
  Modifications    :
******************************************************************************/
void CFlexRayDatabaseDissociateDlg::OnBnClickedCbtnDissociate()
{
    ...
    if(nCount > 0)
    {
        ...
        for(int nTempCnt = 0 ; nTempCnt < nCount ; nTempCnt++)
        {
            ...
            for(int nItr =0; nItr <  nDB; nItr++)
            {
                ...
                {
                    (m_sFibexParams.m_acConfigFileName[nItr]).clear();
                }
            }
