...
public:
    ...
    void vSetValues(STXLINMSGDETAILS* psTxMsg);
    ...
    BOOL bUpdateSignalList(STLIN_MSG sMsg);
...
protected:
    ...
    afx_msg void OnBtnSendSleepFrame();
...
private:
    ...
    BOOL bUpdateMessageDetail(STLIN_MSG* psMsgDetails);
