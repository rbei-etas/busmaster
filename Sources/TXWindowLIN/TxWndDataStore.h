...
public:
    ...
    bool bDeleteMsgList(PSTXLINMSGLIST& psMsgList);
    //copy MsgList from local to global
    bool bCopyMsgList(PSTXLINMSGLIST&  ppsDestTxCANMsgList , PSTXLINMSGLIST*  ppsSrcTxCANMsgList);
    ...
    int nCompareMsgList(PSTXLINMSGLIST TxLinMsgListSrc,PSTXLINMSGLIST TxLinMsgListDest);
private:
    ...
    void vInitialiseMsgDetails(PSTXLINMSGLIST& psMsgDetails);
