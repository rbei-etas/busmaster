...
#define defSTR_Warning7 "(Unsupported Key Handler) :%s has not been converted"
#define defSTR_Warning8 "Load DBC Converter is Failed.\nConversion will continue with out using Database Files","Warning"
#define defSTR_Warning9 "No DBC Files are Added.If the CAPL File have any DBC messages converted file cpp may not compile.\n\nDo you want to continue?","Warning"
...
#define defSTR_ConvertedkeyInfo "(Unsupported Key Handler) :'%s' has been replaced with '%c'"
