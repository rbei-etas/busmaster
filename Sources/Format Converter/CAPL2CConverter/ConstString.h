...
#define defSTR_LongCnvrt "*long_CAPL((STCAN_MSG*)&%s,%s.m_ucDLC, %s)"
#define defSTR_ByteCnvrt "*byte_CAPL((STCAN_MSG*)&%s,%s.m_ucDLC, %s)"
#define defSTR_WordCnvrt "*word_CAPL((STCAN_MSG*)&%s,%s.m_ucDLC, %s)"
