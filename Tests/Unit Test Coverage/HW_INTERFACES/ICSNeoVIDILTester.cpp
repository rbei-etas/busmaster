...
#include "CAN_ICS_neoVI/CAN_ICS_neoVI_Channel.h" // For CChannel class declaration
#include "CAN_ICS_neoVI/CAN_ICS_neoVI_Network.h"
...
BOOST_AUTO_TEST_CASE( DIL_Negative_Test_Cases)
{
	...
	/* Test Nwtwork and channel objects */
	CNetwork odSimulationNetwork;
	CChannel objChannel;

	odSimulationNetwork.m_aodChannels[0] = 	objChannel;
	odSimulationNetwork.m_aodChannels[0].vResetChannel();
	odSimulationNetwork.m_aodChannels[0].m_ucTxErrorCounter = 255;
	odSimulationNetwork.m_aodChannels[0].m_ucTxErrorCounter = 256;
	odSimulationNetwork.m_aodChannels[0].vUpdateErrorCounter(255,254);
	odSimulationNetwork.m_aodChannels[0].vUpdateErrorCounter(254,255);

	odSimulationNetwork.~CNetwork();
