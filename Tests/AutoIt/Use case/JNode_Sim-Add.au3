...
if WinExists("BUSMASTER") Then
	...
	controlclick("BUSMASTER","UnLoad",1005)
	...
	if WinExists("SaveAs Configuration Filename...") Then
		controlsettext("SaveAs Configuration Filename...","",1152,"J1939saveastest")	; Enter file name in SaveAs Configuration Filename dialog
