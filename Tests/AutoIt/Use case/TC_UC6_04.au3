...
sleep(1000)
if ($type[7] or $type[8]="BROADCAST") and $match=1 and $chkDB=1 and $DLC[7]=21 Then
			_ExcelWriteCell($oExcel, "Pass", 34, 10)
		Else
			_ExcelWriteCell($oExcel, "Fail", 34, 10)
		EndIf
