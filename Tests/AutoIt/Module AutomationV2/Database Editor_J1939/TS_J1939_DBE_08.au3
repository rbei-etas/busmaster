...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_J1939_DBE_08.au3****"&@CRLF)
...
if $assocDBCount=0 Then
	_WriteResult("Pass","TS_J1939_DBE_08")
Else
	_WriteResult("Fail","TS_J1939_DBE_08")
EndIf
...
if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_J1939_DBE_08")
EndIf

ConsoleWrite("****End : TS_J1939_DBE_08.au3****"&@CRLF)
ConsoleWrite(@CRLF)