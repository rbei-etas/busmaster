...
$timhWnd=ControlGetHandle ($mWin,"",$msgwin)								;handler for tx wimdow
$msg12d=_GUICtrlListView_GetItemTextString($timhWnd, 2)									;selecting last elment in message window
...
If ($sTime12a[6]=0289 And $sTime12b[6]=0121 And $sTime12c[6]=0018 And $sTime12d[6]=0018) Then

	_ExcelWriteCell($oExcel,"pass",17,11)

    Else
	  _ExcelWriteCell($oExcel,"Fail",17,11)
