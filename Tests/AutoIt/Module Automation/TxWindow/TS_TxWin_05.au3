...
If ($sTimefifth1[7]=11 And $sTimefifth2[7]=12 And $sTimefifth3[7]=21 And $sTimefifth4[7]=22 And $sTimefifth5[7]=11 And $sTimefifth6[7]=12 And $sTimefifth7[7]=11 ) Then

	_ExcelWriteCell($oExcel,"pass",10,11)

    Else
	  _ExcelWriteCell($oExcel,"Fail",10,11)
