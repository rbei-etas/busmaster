...
If ($sTimesevnth1[7]=31 And $sTimesevnth2[7]=32 And $msg1="True" And $msg2="True" And $sTimesevnth3[7]=32 And $sTimesevnth4[7]=32 ) Then

	_ExcelWriteCell($oExcel,"pass",12,11)

    Else
	  _ExcelWriteCell($oExcel,"Fail",12,11)
