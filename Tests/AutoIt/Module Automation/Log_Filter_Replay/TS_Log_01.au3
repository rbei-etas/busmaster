...
if winexists($mWin) then
	...
	$LogFilehWd=controlgethandle($dlgcfgLog,"",$logFilelv)							; Fetch handle of log file list view
	...
	$firstFileTimeModeTxt=ControlGetText($dlgcfgLog, "", $LogTimeModectrlID )				; Fetch the time mode
	$firstFileNumModeHex=Controlcommand($dlgcfgLog,"",$LogNumModeHex,"IsChecked")			; Check whether Hex Numeric mode is set
	$firstFileModeOverWrite=Controlcommand($dlgcfgLog,"",$LogfileModeOverWrite,"IsChecked")	; Check whether overwrite file mode is set
	...
	$SecondFileTimeModeTxt=ControlGetText($dlgcfgLog, "", $LogTimeModectrlID )				; Fetch the time mode
	$SecondFileNumModeHex=Controlcommand($dlgcfgLog,"",$LogNumModeDec,"IsChecked")			; Check whether Dec Numeric mode is set
	$SecondFileModeOverWrite=Controlcommand($dlgcfgLog,"",$LogfileModeApp,"IsChecked")		; Check whether Append file mode is set
