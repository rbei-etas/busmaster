...
if winexists($mWin) then
	...
	ControlCommand($mWin,"",$msgIDNameComboctrlID,"SetCurrentSelection",1)		; Add the DB msgs to the Tx message list

	_AddMsg2TxList()															; Click on Add button

	ControlCommand($mWin,"",$msgIDNameComboctrlID,"SetCurrentSelection",2)		; Add the DB msgs to the Tx message list

	_AddMsg2TxList()															; Click on Add button

	ControlCommand($mWin,"",$msgIDNameComboctrlID,"SetCurrentSelection",3)		; Add the DB msgs to the Tx message list

	_AddMsg2TxList()															; Click on Add button

	ControlCommand($mWin,"",$msgIDNameComboctrlID,"SetCurrentSelection",4)		; Add the DB msgs to the Tx message list

	_AddMsg2TxList()															; Click on Add button

	ControlCommand($mWin,"",$msgIDNameComboctrlID,"SetCurrentSelection",5)		; Add the DB msgs to the Tx message list
