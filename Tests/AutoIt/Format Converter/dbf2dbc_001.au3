...
; Compare generated/expected dbc file
$Ret = RunWait(@ComSpec & " /c FC /B out\" & $TestName & ".dbc " & $TestName & "_expected.dbc", @ScriptDir, @SW_HIDE)
If $Ret Then
	ConsoleWriteError("Unexpected dbc file" & @CRLF)
EndIf
