...
FileCopy ( $BusMasterExeFPath & "\GCCDLLMakeTemplate_CAN", "C:\Windows\SysWOW64", 1)
...
Local $foo = Run('"C:\Program Files (x86)\AutoIt3\SciTE\AutoIt3Wrapper\AutoIt3Wrapper.exe" /run /prod /ErrorStdOut /in "C:\Module_AutomationV2\NodeSimulationLIN\NodeSimulationLIN.au3" /UserParams', @SystemDir, @SW_SHOW, $STDERR_CHILD + $STDOUT_CHILD)
