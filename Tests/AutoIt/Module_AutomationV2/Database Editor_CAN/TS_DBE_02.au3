...
; Critical (C)		:		Y
; TestCase No.		:		TS_DBE_27
; TestCases			:		"Enter Signal Value: Hexadecimal Mode"
; Test Data			:		-
; Test Setup		:		"1. Import the database.
;~ 							2. Invoke the dialog and Select Signals and select Configure Button.
;~ 							3. Enter signal value for each type of signal one by one"

; Expected Results  : 		"The signal value accepted should be in range of 0 - 7FFFFFFFFFFFFF for unsigned int 64bit signal, -80000000000000 - 7FFFFFFFFFFFFF , for signed int 64bits, -80000000 - 7FFFFFFF for signed int 32bits and 0 - FFFFFFFF for unsigned int 32bits."
;==========================================================================Test Procedure =========================================================================
...
if $sigName="Signal1" and $sigLen=32 and $sigType="int" and $sigByteInd=0 and $sigBitNo=0 and $sigMaxVal="7FFFFFFF" and  $sigMinVal=80000000 Then
	_WriteResult("Pass","TS_DBE_02")
Else
	_WriteResult("Fail","TS_DBE_02")
EndIf

$isAppNotRes=_CloseApp()																		; Close the app

if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_DBE_02")
EndIf
