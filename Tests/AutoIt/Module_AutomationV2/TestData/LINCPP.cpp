...
STLIN_MSG sMsg_1;
  ...
  sMsg_1.messagetype= 1;                 // Slave Response
  sMsg_1.checksumtype = 0;              // Classic
  sMsg_1.dlc = 8;
  sMsg_1.id = 0x1;                // Message Identifier
  sMsg_1.data[1] = 10;  // Lower 4 Bytes
  sMsg_1.data[7] = 20;  // Upper 4 Bytes
  sMsg_1.cluster = 1;
...
STLIN_MSG sMsg2;
  ...
  sMsg2.dlc = 8;
  sMsg2.id = 0x2;                // Message Identifier
