...
;Run all the NodeSimulationJ1939 module scripts
 ...
 ;#include "TS_UserCfx_07.au3"---Need to update for New UI-NodeSim
 #include "TS_UserCfx_08.au3";-Issue
;~  ;---------P2 test cases-------------
#include "TS_UserCfx_10.au3";-Issue
#include "TS_UserCfx_11.au3";-Issue
