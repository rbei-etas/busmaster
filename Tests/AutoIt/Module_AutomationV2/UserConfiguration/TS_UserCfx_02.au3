...
ConsoleWrite("****Start : TS_UserCfx_02.au3****"&@CRLF)
 _launchApp()
	...
	if winexists($WIN_BUSMASTER) Then
	   ...
	   $SubMenuData3=_GUICtrlMenu_GetItemText($Submenuhandle,3)
	   $SubMenuData4=_GUICtrlMenu_GetItemText($Submenuhandle,4)
	   $SubMenuData5=_GUICtrlMenu_GetItemText($Submenuhandle,6)
	   $SubMenuData6=_GUICtrlMenu_GetItemText($Submenuhandle,9)
	   $SubMenuData7=_GUICtrlMenu_GetItemText($Submenuhandle,8)
	   $SubMenuData8=_GUICtrlMenu_GetItemText($Submenuhandle,11)
	   $SubMenuData9=_GUICtrlMenu_GetItemText($Submenuhandle,10)
	    $SubMenuData10=_GUICtrlMenu_GetItemText($Submenuhandle,9)
		 $SubMenuData11=_GUICtrlMenu_GetItemText($Submenuhandle,12)
