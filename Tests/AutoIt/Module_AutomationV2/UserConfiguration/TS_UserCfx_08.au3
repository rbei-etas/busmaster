...
if winexists($WIN_BUSMASTER) Then
	...
	Sleep(1000)
	$Tabtext1=_GUICtrlTab_GetItemText($hWndCAPL2CPP,0)                                           ; Get text of the tab CAPL_2_CPP Converter
	ConsoleWrite("text1 : " & $Tabtext1 & @CRLF)
	sleep(1000)
	_GUICtrlTab_ClickTab($hWndCAPL2CPP, 1)
	$Tabtext2=_GUICtrlTab_GetItemText($hWndCAPL2CPP,1)                                           ; Get text of the tab Log to Excel File Converter
    ConsoleWrite("text2 : " & $Tabtext2 & @CRLF)
	sleep(1000)
	_GUICtrlTab_ClickTab($hWndCAPL2CPP, 2)
    $Tabtext3=_GUICtrlTab_GetItemText($hWndCAPL2CPP,2)                                         	; Get text of the tab Other Converters
