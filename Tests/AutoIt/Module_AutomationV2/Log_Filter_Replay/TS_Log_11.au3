...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_Log_11.au3****"&@CRLF)
...
if winexists($WIN_BUSMASTER) then
	...
	_loadConfig("cfxLog_11")																; Load Configuration

	_ConfigureCANLog("LOG_11_Sample","System","ALL","Decimal","Overwrite","","","True")		; Configure Logging details
...
if _FileCountLines($GetLogFile_Path & "\Log_11_Sample.log")>=20 Then
	$FindRx1=FileReadLine ($GetLogFile_Path & "\LOG_11_Sample.log",17)							; Read the 17th line from the Log file
	...
	$FindRx2=FileReadLine ($GetLogFile_Path & "\LOG_11_Sample.log",18)							; Read the 19th line from the Log file
	...
	$FindRx3=FileReadLine ($GetLogFile_Path & "\LOG_11_Sample.log",20)							; Read the 21th line from the Log file
...
if $RxAllDir="Found" and $RxAllID="Found" Then
	_WriteResult("Pass","TS_Log_11")
Else
	_WriteResult("Fail","TS_Log_11")
EndIf

$isAppNotRes=_CloseApp()															; Close the app

if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_Log_11")
EndIf
