...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_Log_15.au3****"&@CRLF)


_launchApp()

Dim $HexMsgID21Rx1[10]=["","","","","","","","","",""],$HexMsgID21Rx2[10]=["","","","","","","","","",""],$HexMsgID21Rx3[10]=["","","","","","","","","",""],$HexMsgID21Rx4[10]=["","","","","","","","","",""]
if winexists($WIN_BUSMASTER) then

	_loadConfig("cfxLog_15")																; Load Configuration

	_ConfigureCANLog("LOG_15_Sample","System","ALL","Decimal","Overwrite","","","True")		; Configure Logging details
...
if _FileCountLines($GetLogFile_Path & "\Log_15_Sample.log")>=19 Then
	$FindRx1=FileReadLine ($GetLogFile_Path & "\LOG_15_Sample.log",16)							; Read the 17th line from the Log file
	...
	$FindRx2=FileReadLine ($GetLogFile_Path & "\LOG_15_Sample.log",17)				; Read the 19th line from the Log file
	...
	$FindRx3=FileReadLine ($GetLogFile_Path & "\LOG_15_Sample.log",18)				; Read the 21th line from the Log file
	...
	$FindRx4=FileReadLine ($GetLogFile_Path & "\LOG_15_Sample.log",19)				; Read the 21th line from the Log file
...
if $TxAllDir="Found" and $TxAllCH="Found" and $TxAllType="Found" Then
	_WriteResult("Pass","TS_Log_15")
Else
	_WriteResult("Fail","TS_Log_15")
EndIf

$isAppNotRes=_CloseApp()															; Close the app

if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_Log_15")
EndIf

ConsoleWrite("****End : TS_Log_15.au3****"&@CRLF)
ConsoleWrite(@CRLF)