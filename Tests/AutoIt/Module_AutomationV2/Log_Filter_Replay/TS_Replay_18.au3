...
;~ 	_EnableHex()																				; Enable Hex mode
	...
	for $i=0 To 5
		...
		if $Msg[1]="Tx" and $Msg[2]=1 and $Msg[3]="s" and $Msg[4]="0x100"  Then
			$countMsg= $countMsg + 1
		EndIf
		if $Msg[1]="Rx" and $Msg[2]=2 and $Msg[3]="s" and $Msg[4]="0x100"  Then
			$countMsg= $countMsg + 1
		EndIf
		...
		if $Msg[1]="Tx" and $Msg[2]=2 and $Msg[3]="s" and $Msg[4]="0x100"  Then
			$countMsg= $countMsg + 1
		EndIf
		if $Msg[1]="Rx" and $Msg[2]=1 and $Msg[3]="sr" and $Msg[4]="0x200"  Then
			$countMsg= $countMsg + 1
		EndIf
		if $Msg[1]="Tx" and $Msg[2]=2 and $Msg[3]="sr" and $Msg[4]="0x200"  Then
			$countMsg= $countMsg + 1
		EndIf
