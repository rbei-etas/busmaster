...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_Log_12.au3****"&@CRLF)
...
if winexists($WIN_BUSMASTER) then
	_loadConfig("cfxLog_12")																; Load Configuration

	_ConfigureCANLog("LOG_12_Sample","System","ALL","Decimal","Overwrite","","","True")		; Configure Logging details
...
if _FileCountLines($GetLogFile_Path & "\Log_12_Sample.log")>=21 Then
	$FindRx1=FileReadLine ($GetLogFile_Path & "\LOG_12_Sample.log",17)							; Read the 17th line from the Log file
	...
	$FindRx2=FileReadLine ($GetLogFile_Path & "\LOG_12_Sample.log",19)							; Read the 19th line from the Log file
	...
	$FindRx3=FileReadLine ($GetLogFile_Path & "\LOG_12_Sample.log",21)							; Read the 21th line from the Log file
...
if $HexMsgID21Rx1[2]="Rx" and $HexMsgID21Rx2[2]="Rx" and $HexMsgID21Rx3[2]="Rx" then
	$RxAllDir="Found"
Else
	$RxAllDir="Not Found"
EndIf
...
if $HexMsgID21Rx1[3]=1 and $HexMsgID21Rx2[3]=1 and $HexMsgID21Rx3[3]=1 then
	$RxAllCH="Found"
Else
	$RxAllCH="Not Found"
EndIf
...
if $RxAllDir="Found" and $RxAllCH="Found" Then
	_WriteResult("Pass","TS_Log_12")
Else
	_WriteResult("Fail","TS_Log_12")
EndIf

$isAppNotRes=_CloseApp()															; Close the app

if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_Log_12")
EndIf


ConsoleWrite("****End : TS_Log_12.au3****"&@CRLF)
ConsoleWrite(@CRLF)