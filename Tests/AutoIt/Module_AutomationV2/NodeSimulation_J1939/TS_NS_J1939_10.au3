...
if winexists($WIN_BUSMASTER) then
	...
	ControlSend($WIN_BUSMASTER, "", $TXT_TimeHandler_CPPFile, "msg.m_sMsgProperties.m_uExtendedID.m_unExtID =0x100;" & @CRLF)
	...
	If($ChannelInfo=1 And $DLC=1 And $DataBytes=1) Then
