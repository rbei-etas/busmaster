...
; Critical (C)		:		Y
; TestCase No.		:		TS_J1939_DBE_52
; TestCases			:		Message Details
; Test Data			:
; Test Setup		:		1. Continue from above test case TS_J1939_DBE_51.
...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_J1939_DBE_52.au3****"&@CRLF)
...
if $msglentxt=1785 and $SignalCount=0 Then
	_WriteResult("Pass","TS_J1939_DBE_52")
Else
	_WriteResult("Fail","TS_J1939_DBE_52")
EndIf

$isAppNotRes=_CloseApp()																				; Close the app

if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_J1939_DBE_52")
EndIf

ConsoleWrite("****End : TS_J1939_DBE_52.au3****"&@CRLF)
ConsoleWrite(@CRLF)