...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_J1939_DBE_10.au3****"&@CRLF)

_launchApp()
WinActivate($WIN_BUSMASTER,3)
if winexists($WIN_BUSMASTER) then
	_openJ1939DB("testJ1939DBE_10")																		; Open DBF file
...
Else
	_WriteResult("Fail","TS_J1939_DBE_10")
EndIf
...
if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_J1939_DBE_10")
EndIf

ConsoleWrite("****End : TS_J1939_DBE_10.au3****"&@CRLF)
ConsoleWrite(@CRLF)