...
; Critical (C)		:		Y
; TestCase No.		:		TS_LIN_Log_28                                                          SOURCE : (TS_LIN_Log_12)
...
ConsoleWrite(@CRLF)
ConsoleWrite(@CRLF)
ConsoleWrite("****Start : TS_LIN_Log_28.au3****"&@CRLF)
...
if winexists($WIN_BUSMASTER) then
	...
	_ConfigureLINLog("LOG_28_Sample","System","ALL","Decimal","Overwrite","","","True")		    ; Configure Logging details
...
if $isAppNotRes=1 Then
	_WriteResult("Warning","TS_LIN_Log_28")
EndIf


ConsoleWrite("****End : TS_LIN_Log_28.au3****"&@CRLF)
ConsoleWrite(@CRLF)