...
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0001
    {	None	= 0,
	Start	= ( None + 1 ) ,
	Stop	= ( Start + 1 ) ,
	Both	= ( Stop + 1 ) ,
...
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0002
    {	System	= 0,
	Absolute	= ( System + 1 ) ,
	Relative	= ( Absolute + 1 ) 
    } 	eTimeMode;
...
typedef /* [public][public][public][public][public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0003
    {	Hex	= 0,
	Deci	= ( Hex + 1 ) 
    } 	eNumericMode;

typedef /* [public][public][public][public][public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0004
    {	Append	= 0,
	OverWrite	= ( Append + 1 ) 
    } 	eFileMode;

typedef /* [public][public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0005
    {	Signal_watch	= 0,
...
typedef /* [public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0006
    {	Active	= 0,
	Passive	= ( Active + 1 ) ,
...
typedef /* [public][public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0007
    {	all	= 0,
	timers	= ( all + 1 ) ,
	key	= ( timers + 1 ) ,
	message	= ( key + 1 ) ,
...
typedef /* [public][public] */ 
enum __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0008
    {	Log	= 0,
	Display	= ( Log + 1 ) 
    } 	EFILTERMODULE;

typedef /* [public][public][public][public] */ struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0009
    {
...
typedef /* [public][public] */ struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0010
    {
    double m_dBusLoad;
...
typedef /* [public][public] */ struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0011
    {
...
typedef /* [public][public][public] */ struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0012
    {
...
typedef struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0012 *PSFILTER_USR;

typedef /* [public][public][public][public][public] */ struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0013
    {
...
typedef struct __MIDL___MIDL_itf_CAN_Monitor_0000_0000_0013 *PSLOGTRIGGER_USR;
