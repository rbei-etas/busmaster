...
Section "BUSMASTER"
	...
	; Deleting If CAN_ETAS_BOA_2.dll exists
	IfFileExists $INSTDIR\CAN_ETAS_BOA_2.dll bCanEtas2bExists
	bCanEtas2bExists:
	...
	; Deleting If FLEXRAY_ETAS_BOA_2.dll exists
	IfFileExists $INSTDIR\FLEXRAY_ETAS_BOA_2.dll bFlexEtasb2Exists
	bFlexEtasb2Exists:
