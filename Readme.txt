...
3.2 For ES 581 (vendor is ETAS GmbH),  please procure the hardware from the vendor and install the driver.  
3.3 For BOA (vendor is ETAS GmbH), the same has to be procured from the vendor and installed
